<template>
    <div class="page-body">
        <CommonBreadcrumb title="Family House" page="Types"/> 
...
const {data} = await useFetch(baseUrl+'/data/data.json');
const alldata:listdata[] = data.value.typeproperty
</script>
